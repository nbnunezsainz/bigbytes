...
// Internship routes
router.route('/AddInternship').post(AuthenticationController.verifyToken,InternshipController.addInternship);
...
router.route('/RequestReferal').get(AuthenticationController.verifyToken,UserController.getUserAndResume, InternshipController.requestReferal);
